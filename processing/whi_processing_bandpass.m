...
for fId = 1:NumFiles
    ...
    for bId = 1:nbands
        P(:, bId, :) = proc_bandpass(s_filt, bandranges{bId}, h.SampleRate);
    end
    ...
    settings.bandpass.bands         = bandranges;
    settings.bandpass.winsize       = winsize;
    settings.bandpass.bandlabels    = bandlabels;
